...
import type { NodeData, HotReloadable } from '../../types'
import type { AvatarFactory, AvatarHooks } from '../../types/nodes'
...
interface AvatarData extends NodeData {
  src?: string | null;
  emote?: string | null;
