 ...
 * 
 * Extends RPGEntity to provide interaction-specific functionality including:
...
import type { RPGEntityConfig, EntityInteractionData } from '../types/entities';
import type { Position3D } from '../types/core';

export interface InteractableConfig extends RPGEntityConfig {
  interaction?: {
    prompt?: string;
    description?: string;
    range?: number;
...
export abstract class InteractableEntity extends RPGEntity {
