/**
 * @deprecated BaseEntity is deprecated - use RPGEntity instead
 * 
 * This class has been consolidated into RPGEntity for better inheritance hierarchy.
 * All functionality from BaseEntity has been moved to RPGEntity.
 * This file will be removed in a future version.
 * 
 * @see RPGEntity for the new base class for all RPG entities
 */
