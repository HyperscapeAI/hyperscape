...
import { RPGStoreItem } from '../types/core';

// Store item definitions - single source of truth
export const STORE_ITEMS: Record<string, Omit<RPGStoreItem, 'stockQuantity'>> = {
  bronze_hatchet: {
    id: 'bronze_hatchet',
...
export function getStoreItem(itemId: string, stockQuantity: number = -1): RPGStoreItem {
