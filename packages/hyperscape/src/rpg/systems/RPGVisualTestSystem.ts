...
import type { PlayerData, RPGInteractionSystem, RPGItem, RPGMobData, RPGNPC, RPGResource } from '../types/core';
 ...
 */
export class RPGVisualTestSystem extends RPGSystemBase {
  ...
  constructor(world: World) {
    super(world, {
      name: 'rpg-visual-test',
      dependencies: {
        required: [],
        optional: ['rpg-player', 'rpg-mob', 'rpg-item', 'rpg-resource', 'rpg-npc']
      },
      autoCleanup: true
    });
  ...
  private createPlayerCube(playerData: PlayerData): void {
  ...
  private createMobCube(mobData: RPGMobData): void {
  ...
  private createItemCube(itemData: RPGItem): void {
    // Validate required fields
    if (!itemData) {
      console.warn('[RPGVisualTestSystem] createItemCube called with null/undefined itemData');
      return;
    }
  ...
  private createResourceCube(resourceData: RPGResource): void {
  ...
  private createNPCCube(npcData: RPGNPC): void {
  ...
  private registerAllCubesWithInteractionSystem(): void {
    ...
    const interactionSystem = getSystem<RPGInteractionSystem>(this.world, 'rpg-interaction');
    if (!interactionSystem) {
      console.warn('[RPGVisualTestSystem] Interaction system not found, cannot register cubes');
      return;
    }
   ...
   */
  private registerMobWithInteractionSystem(interactionSystem: RPGInteractionSystem, entity: VisualTestEntity): void {
   ...
   */
  private registerItemWithInteractionSystem(interactionSystem: RPGInteractionSystem, entity: VisualTestEntity): void {
    // Interface guarantees this method exists
   ...
   */
  private registerResourceWithInteractionSystem(interactionSystem: RPGInteractionSystem, entity: VisualTestEntity): void {
    // Interface guarantees this method exists
   ...
   */
  private registerNPCWithInteractionSystem(interactionSystem: RPGInteractionSystem, entity: VisualTestEntity): void {
    // Interface guarantees this method exists
