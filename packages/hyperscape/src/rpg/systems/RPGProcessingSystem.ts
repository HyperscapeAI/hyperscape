...
import { RPGFire, RPGProcessingAction } from '../types/core';
...
export class RPGProcessingSystem extends RPGSystemBase {
  ...
  async init(): Promise<void> {
    ...
    this.world.on(EventType.PLAYER_UNREGISTERED, this.cleanupPlayerData.bind(this));
  ...
  getFiresInRange(position: { x: number; y: number; z: number }, range: number): RPGFire[] {
