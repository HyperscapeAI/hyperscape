...
function createMockItem(id: string, name: string, type: ItemType = ItemType.ARMOR, overrides: Partial<RPGItem> = {}): RPGItem {
  return {
    id,
    name,
    type,
...
describe('EquipmentBonusCalculator', () => {
  ...
  describe('calculateTotalBonuses', () => {
    it('should calculate empty bonuses when no equipment', () => {
      const equipment: Record<string, RPGItem | null> = {}
    ...
    it('should calculate bonuses from single piece of equipment', () => {
      const helmet: RPGItem = createMockItem('iron_helmet', 'Iron helmet', ItemType.ARMOR, {
    ...
    it('should sum bonuses from multiple equipment pieces', () => {
      ...
      const platebody: RPGItem = createMockItem('iron_platebody', 'Iron platebody', ItemType.ARMOR, {
    ...
    it('should handle items without bonuses', () => {
      const item: RPGItem = createMockItem('cooking_pot', 'Cooking pot', ItemType.TOOL, {
  ...
  describe('meetsRequirements', () => {
    ...
    it('should return true for items with no requirements', () => {
      const item: RPGItem = createMockItem('bronze_sword', 'Bronze sword', ItemType.WEAPON, {
        value: 50,
    ...
    it('should return true when player meets all requirements', () => {
      const item: RPGItem = createMockItem('iron_sword', 'Iron sword', ItemType.WEAPON, {
        value: 200,
        requirements: {
          level: 30,
          skills: {
    ...
    it('should return false when player does not meet requirements', () => {
      const item: RPGItem = createMockItem('dragon_sword', 'Dragon sword', ItemType.WEAPON, {
        value: 50000,
        requirements: {
          level: 60,
          skills: {
    ...
    it('should handle multiple requirements', () => {
      const item: RPGItem = createMockItem('magic_bow', 'Magic bow', ItemType.WEAPON, {
        value: 10000,
        requirements: {
          level: 50,
          skills: {
  ...
  describe('getEquipmentWeight', () => {
    ...
    it('should handle items without weight property', () => {
      const item: RPGItem = createMockItem('weightless_item', 'Weightless item', ItemType.ARMOR, {
        equipSlot: EquipmentSlotName.HELMET,
        value: 100,
        weight: 0 // No weight
      })
