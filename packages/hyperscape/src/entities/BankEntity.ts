/**
 * BankEntity - Bank buildings extending Entity
...
export class BankEntity extends StorageEntity {
  ...
  /**
   * Create the bank building's visual representation - implements Entity.createMesh
   */
  protected async createMesh(): Promise<void> {
    ...
    this.mesh = bankGroup; // Set main mesh for Entity (Group extends Object3D)
