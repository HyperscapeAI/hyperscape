...
// Helper function to create Item with sensible defaults
function createItem(partial: Partial<Item> & Pick<Item, 'id' | 'name' | 'type'>): Item {
...
function createWeapon(partial: Partial<Item> & Pick<Item, 'id' | 'name'> & { weaponType: WeaponType; attackType: AttackType }): Item {
  return createItem({
    ...partial,
...
const itemsObject: { [key: string]: Item } = {}
