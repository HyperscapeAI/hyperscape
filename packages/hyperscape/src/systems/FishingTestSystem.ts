...
export class FishingTestSystem extends VisualTestFramework {
  ...
  async init(): Promise<void> {
    ...
    const resourceSystem = getSystem<ResourceSystem>(this.world, 'rpg-resource');
    const inventorySystem = getSystem<InventorySystem>(this.world, 'rpg-inventory');
    const xpSystem = getSystem<SkillsSystem>(this.world, 'rpg-skills');
