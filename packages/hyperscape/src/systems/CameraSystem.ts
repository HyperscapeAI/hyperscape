/**
 * Camera System
 * Overrides default Hyperscape camera controls with MMO-style controls:
...
import type { PlayerTarget, RendererWithDomElement } from '../types/nodes'
...
export class CameraSystem extends SystemBase {
  ...
  private tryInitialize(): void {
    ...
    if (!this.canvas) {
      console.warn('[CameraSystem] Canvas not available yet')
      return
    }
    ...
    if (!this.camera) {
      console.warn('[CameraSystem] Camera not available')
      return
    }
