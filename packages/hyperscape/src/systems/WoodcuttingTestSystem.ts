...
export class WoodcuttingTestSystem extends VisualTestFramework {
  ...
  async init(): Promise<void> {
    ...
    setTimeout(() => {
      this.resourceSystem = getSystem(this.world, 'rpg-resource') as ResourceSystem
      this.inventorySystem = getSystem(this.world, 'rpg-inventory') as InventorySystem
      this.xpSystem = getSystem(this.world, 'rpg-skills') as SkillsSystem
