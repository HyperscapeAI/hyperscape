...
export class ResourceGatheringTestSystem extends VisualTestFramework {
  ...
  async init(): Promise<void> {
    ...
    this.resourceSystem = getSystem<ResourceSystem>(this.world, 'rpg-resource')!;
    this.processingSystem = getSystem<ProcessingSystem>(this.world, 'rpg-processing')!;
    this.xpSystem = getSystem<SkillsSystem>(this.world, 'rpg-skills')!;
